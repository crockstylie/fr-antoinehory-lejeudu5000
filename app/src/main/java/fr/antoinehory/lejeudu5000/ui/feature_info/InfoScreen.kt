...
// Note: These should ideally be in a separate InfoUiState.kt file.
...
// --- End of Data classes for UiState ---
...
fun InfoScreenPreview() {
    LeJeuDu5000Theme {
        val mockViewModel = object : InfoViewModel() { // ViewModel is open, can be extended
...
fun InfoScreenPreviewLandscape() {
    LeJeuDu5000Theme {
        val mockViewModel = object : InfoViewModel() {
